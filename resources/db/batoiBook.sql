...
INSERT INTO `courses` (`id`, `cycle`, `idFamily`, `vliteral`, `cliteral`)
VALUES (3, 'CFM APD (LOE)', 2, 'Atenció a persones en situació de dependència',
       ...
       (30, 'CFS ASIX (LOE)', 24, 'Administració de sistemes informàtics en xarxa',
        'Administración de sistemas informáticos en red'),
       (32, 'CFS DAM (LOE)', 24, 'Desenrotllament d\'aplicacions multiplataforma',
       ...
       (38, 'CFS DIREC.RESTAURACIÓ (LOE)', 10, 'Direcció en servicis de restauració',
       ...
       (51, 'CFS RXMN (LOE)', 6, 'Imatge per al diagnòtic i medicina nuclear',
       ...
       (59, 'MASTER CIBERSEGURETAT', 24,
        'Curs d\'EspecialiTzació en Ciberseguretat en Entorns de les Tecnologies de la Información',
...
INSERT INTO `families` (`id`, `cliteral`, `vliteral`)
VALUES (1, 'INGLES', 'ANGLES'),
...
INSERT INTO `modules` (`code`, `cliteral`, `vliteral`, `idCycle`)
VALUES ('0011', 'Didáctica de la educación infantil', 'Didàctica de l\'educación infantil', 39),
       ...
       ('0031', 'Seguridad e higiene en la manipulación de alimentos',
        'Seguretat i higiene en la manipulació d\'aliments', 12),
       ...
       ('0210', 'Organización de la atención a las personas en situación dedependencia',
        'Organització de l\'atenció a les persones en situació de dependència', 3),
       ...
       ('0212', 'Características y necesidades de las personas en situación de dependencia',
        'Característiques i necessitats de les persones en situació de dependència', 3),
       ...
       ('028501', 'Operaciones administrativas y documentación sanitaria',
        'Operacions administratives i documentació sanitària', 8),
       ('028502', 'Técnicas básicas de enfermería', 'Tècniques bàsiques d\'infermeria', 8),
       ('028503', 'Higiene del medio hospitalario y limpieza de material',
        'Higiene del medi hospitalari i neteja de material', 8),
       ('028504', 'Promoción de la salud y apoyo psicológico al paciente',
        'Promoció de la salut i suport psicològic al pacient', 8),
       ...
       ('0343', 'Sistemas alternativos y aumentativos de comunicación',
        'Sistemes alternatius i augmentatius de comunicació', 44),
       ...
       ('0373', 'Lenguajes de marcas y sistemas de gestión de información',
        'Llenguatges de marques i sistemes de gestió d\'informació', 30),
       ...
       ('0377', 'Administración de Sistemas Gestores de Bases de Datos',
        'Administració de Sistemes Gestors de Bases de Dades', 30),
       ...
       ('0496', 'Control del aprovisionamiento de materias primas',
        'Control de l\'aprovisionament  de matèries primeres', 36),
       ('0497', 'Procesos de preelaboración y conservación en cocina',
        'Processos de preelaboració i conservació en cuina', 36),
       ...
       ('0501', 'Gestión de la calidad y de la seguridad e higiene alimentaria',
        'Gestió de la qualitat i de la seguretat i higiene alimentàries', 36),
       ('0502', 'Gastronomía y nutrición', 'Gastronomia i nutrició', 36),
       ('0503', 'Gestión administrativa y comercial en restauración',
        'Gestió administrativa i comercial en restauració', 36),
       ('0504', 'Recursos humanos y dirección de equipos en restauración',
        'Recursos humans i direcció d\'equips en restauració', 36),
       ...
       ('0512', 'Planificación y dirección de servicios y eventos en restauración',
        'Planificació i direcció de servicis i esdeveniments en restauració', 38),
       ...
       ('0647', 'Gestión de la documentación jurídica y empresarial',
        'Gestió de la documentació jurídica i empresarial', 28),
       ('0648', 'Recursos humanos y responsabilidad social corporativa',
        'Recursos humans i responsabilitat social corporativa ', 28),
       ...
       ('0750', 'Procesos fisiológicos y de higiene en imagen personal ',
        'Processos fisiològics i d\'higiene en imatge personal', 42),
       ...
       ('1351', 'Técnicas de tomografía computarizada y ecografía', 'Tècniques de tomografia computada i ecografia',
        51),
       ...
       ('1355', 'Proyecto de imagen para el diagnóstico y medicina nuclear',
        'Projecte d¿Imatge per al Diagnòstic i Medicina Nuclear', 51),
       ...
       ('3062', 'Depilación mecánica y decoloración del vello superfluo',
        'Depilació mecànica i decoloració del borrissol superflu', 57),
       ...
       ('CV0001', 'Inglés Técnico I-M / Horario reservado para la docencia en inglés',
        'Anglés Tècnic I-M / Horari reservat per a la docència en anglés', 3),
       ('CV0002', 'Inglés Técnico II-M / Horario reservado para la docencia en inglés',
        'Anglés Tècnic II-M / Horari reservat per a la docència en anglés', 3),
       ('CV0003', 'Inglés Técnico I-S / Horario reservado para la docencia en inglés',
        'Inglés Técnico I-S / Horario reservado para la docencia en inglés', 28),
       ('CV0004', 'Inglés Técnico II-S / Horario reservado para la docencia en inglés',
        'Anglés Tècnic II-S / Horari reservat per a la docència en anglés', 28),
...
INSERT INTO `users` (`id`, `email`, `nick`, `password`)
VALUES (2, 'ignasi.gomis.mullor@gmail.com', 'Ignasi', '81dc9bdb52d04dc20036dbd8313ed055');
